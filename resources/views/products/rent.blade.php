					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
                                <img style="width:300px;" class="1" src="{{ asset('/img/backend_img/products/large/'.$productDetails->image) }}" alt="" />
                                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                                    <a id="" href="{{ asset('/img/backend_img/products/large/'.$productDetails->image) }}" >
                                        <img style="width:300px; margin-top: 30px;" class="" src="{{ asset('/img/backend_img/products/large/'.$productDetails->image) }}" alt="" />
                                    </a>
                                </div>
							</div>
